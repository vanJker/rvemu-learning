...
enum insn_type_t {
    ...
    insn_flw, insn_fsw,
    insn_fmadd_s, insn_fmsub_s, insn_fnmsub_s, insn_fnmadd_s,
    insn_fadd_s, insn_fsub_s, insn_fmul_s, insn_fdiv_s, insn_fsqrt_s,
    ...
    insn_fcvt_s_w, insn_fcvt_s_wu, insn_fmv_w_x,
    insn_fcvt_l_s, insn_fcvt_lu_s,
    ...
    insn_fcvt_w_d, insn_fcvt_wu_d, insn_fmv_x_d,
    insn_feq_d, insn_flt_d, insn_fle_d, insn_fclass_d,
    insn_fcvt_d_w, insn_fcvt_d_wu, insn_fmv_d_x,
    insn_fcvt_l_d, insn_fcvt_lu_d,
    insn_fcvt_d_l, insn_fcvt_d_lu,
    num_insns,
};
